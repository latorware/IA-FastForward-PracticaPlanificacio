...
public class generadorProblemExtension3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter myWriter = new FileWriter("ProblemExtension3.pddl");
        myWriter.write("(define (problem ProblemExtension3)\n");
        ...
        myWriter.write("        (= (plazas_sin_ocupar) 0)\n");
        myWriter.write("    )\n");
        myWriter.write("    (:goal (forall (?x - reserva) (assignada ?x)))\n");
        myWriter.write("    (:metric maximize (- (reservas_asignadas) (plazas_sin_ocupar)))\n");
